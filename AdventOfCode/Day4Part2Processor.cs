...
public class Day4Part2Processor : IDayProcessor
{
    public void ProcessFile(string dayPath, string selectedFile)
    {
        ...
        try
        {
            ...
            do
            {
                ...
                {
                    changed = true;
                    totalCountOfSymbols += toChange.Count;
            ...
            Console.WriteLine($"Total count of elements with less than 4 adjacent \'@\': {totalCountOfSymbols}");
        }
        catch (Exception e)
        {
